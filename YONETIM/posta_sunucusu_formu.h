#ifndef POSTA_SUNUCUSU_FORMU_H
#define POSTA_SUNUCUSU_FORMU_H

#include <QtGui/QDialog>
#include <form_kernel.h>

namespace Ui {
    class POSTA_SUNUCUSU_FORMU;
}

class POSTA_SUNUCUSU_FORMU : public FORM_KERNEL
{
    Q_OBJECT

public:
                    POSTA_SUNUCUSU_FORMU                       (QWidget *parent = 0);
                    ~POSTA_SUNUCUSU_FORMU                      () {};
protected:
...
private:
         Ui::POSTA_SUNUCUSU_FORMU   *    m_ui;

};

#endif // POSTA_SUNUCUSU_FORMU_H
