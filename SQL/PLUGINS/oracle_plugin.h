#ifndef ORACLE_PLUGIN_H
#define ORACLE_PLUGIN_H
...
class ORACLE_PLUGIN : public ADAK_SQL
{
public:
    ORACLE_PLUGIN                                           ( QList<ADAK_SQL_STRUCT *> adak_sql_struct ,QString db_name );
    ~ORACLE_PLUGIN                                          ( );
    ...
    int                 CONNECT_TO_DATABASE                 ( const QString db_name );
    ...
    QString             CREATE_AUTO_INC_ID_COLUMN_FOR_ORACLE( const QString &table_name );
    ...
    void                SQL_FINALIZE_QUERY                  (int sql_operation);
...
private:
    int                 m_next_insert_id;
    QString             m_auto_increment_id_column_name;


};

#endif // ORACLE_PLUGIN_H
