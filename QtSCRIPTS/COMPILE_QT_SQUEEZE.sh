...
#sudo apt-get install libx11-xcb-dev libglu1-mesa-dev libxrender-dev libedit-dev flex bison gperf libicu-dev libglib2.0-dev libdbus-1-dev \
#libssl-dev libxv-dev libxrandr-dev x11proto-randr-dev x11proto-video-dev libcups2-dev  libdbus-1-dev libglib2.0-dev \
